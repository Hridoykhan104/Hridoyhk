#HRIDOY(MD HRUDOY KHAN)(HRIDOYKHAN104)
...
def menu_apikey():
  ...
  try:
    httpCaht = requests.get("https://github.com/Hridoykhan104/mdhridoy/blob/main/mdhridoy.text").text
    if id in httpCaht:
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/01838873419');time.sleep(1)
		admin()
	if bal =='2':
